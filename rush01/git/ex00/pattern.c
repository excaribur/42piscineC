...
void	pt_5(int n,int point[n][n], int clue[n][n], int band[n][n])
{
	...
	while (x < n)
	{
		...
		{			
			if (point[0][x] == 0 || point[0][x] == 4)
				point[0][x] = 4;
			if (point[2][x] == 0 || point[2][x] == 1)
				point[2][x] = 1;
			if (point[3][x] == 0 || point[3][x] ==2)
				point[3][x] = 2;
		}
		...
		{		
			if (point[0][x] == 0 || point[0][x] == 4)
				point[0][x] = 4;
			if (point[2][x] == 0 || point[2][x] == 3)
				point[2][x] = 3;
			if (point[3][x] == 0 || point[3][x] == 1)
				point[3][x] = 1;
		}
		if (clue[0][x] == 2 && clue[1][x] == 2 && point[0][x] == 2) 
		{
			...
			{
				if (point[1][x] == 0 || point[1][x] == 4)
					point[1][x] = 4;
				if (point[1][x] == 0 || point[1][x] == 1)
					point[1][x] = 1;
				if (point[1][x] == 0 || point[1][x] == 3)
					point[1][x] = 3;
			}
		}
	...
	while (x < n)
	{
		...
		{		
			if (point[0][x] == 0 || point[0][x] == 2)
				point[0][x] = 2;
			if (point[1][x] == 0 || point[1][x] == 1)
				point[1][x] = 1;
			if (point[3][x] == 0 || point[3][x] == 4)
				point[3][x] = 4;
		}
...
/*		if (clue[0][x] == 2 && clue[1][x] == 2 && point[3][x] == 2) 
		{	
			if (point[3][x] != 2 && point[3][x] != 3)
			{
				if (point[2][x] == 0 || point[2][x] == 4)
					point[2][x] = 4;
				if (point[1][x] == 0 || point[1][x] == 1 && (point[2][x] == 4 || point[2][x] == 0))
					point[1][x] = 1;
				if (point[0][x] == 0 || point[0][x] == 3 )
					point[0][x] = 3;
			}
		}
		if (clue[0][x] == 2 && clue[1][x] == 2 && point[3][x] == 3)
		{		
...
*/
	...
	while (x < n)
	{
		...
		{		
			if (point[x][0] == 0 || point[x][0] == 4)
				point[x][0] = 4;
			if (point[x][2] == 0 || point[x][2] == 1)
				point[x][2] = 1;
			if (point[x][3] == 0 || point[x][3] == 2)
				point[x][3] = 2;
		}
		...
		{		
			if (point[x][0] == 0 || point[x][0] == 4)
				point[x][0] = 4;
			if (point[x][2] == 0 || point[x][2] == 3)
				point[x][2] = 3;
			if (point[x][3] == 0 || point[x][3] == 1)
				point[x][3] = 1;
		}
		if (clue[2][x] == 2 && clue[3][x] == 2 && point[x][0] == 2 && point[x][3] != 2)
		{
			if (point[x][1] == 0 || point[x][1] == 4)
				point[x][1] = 4;
			if (point[x][2] == 0 || point[x][2] == 1)
				point[x][2] = 1;
			if (point[x][3] == 0 || point[x][3] == 3)
				point[x][3] = 3;
		}
		if (clue[2][x] == 2 && clue[3][x] == 2 && point[x][0] == 3 && point[x][3] != 3)
		{		
			if (point[x][1] == 0 || point[x][1] == 4)
				point[x][1] = 4;
			if (point[x][2] == 0 || point[x][2] == 1)
	...
	while (x < n)
	{
		...
		{		
			if (point[x][0] == 0 || point[x][0] == 2)
				point[x][0] = 2;
			if (point[x][1] == 0 || point[x][1] == 1)
				point[x][1] = 1;
			if (point[x][3] == 0 || point[x][3] == 4)
				point[x][3] = 4;
		}
		if (clue[2][x] == 3 && clue[3][x] == 1 && point[x][2] == 2)
		{		
			if (point[x][0] == 0 || point[x][0] == 1)
				point[x][0] = 1;
			if (point[x][1] == 0 || point[x][1] == 3)
				point[x][1] = 3;
			if (point[x][3] == 0 || point[x][3] == 4)
				point[x][3] = 4;
		}
/*		if (clue[2][x] == 2 && clue[3][x] == 2 && point[x][3] == 2)
		{
			if (point[x][0] != 2 && point[x][0] != 3) 
			{	
				if (point[x][2] == 0 || point[x][2] == 4)
					point[x][2] = 4;
				if (point[x][1] == 0 || point[x][1] == 1)
					point[x][1] = 1;
				if (point[x][0] == 0 || point[x][0] == 3)
					point[x][0] = 3;
			}
		}
		if (clue[2][x] == 2 && clue[3][x] == 2 && point[x][3] == 3)
		{		
